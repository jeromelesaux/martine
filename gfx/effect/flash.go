...
func AutoFlash(in image.Image,
	...
	flashPalettePath1 := filepath.Join(cfg.ScrCfg.OutputPath, flashPaletteFilename1)
	...
	flashPalettePath2 := filepath.Join(cfg.ScrCfg.OutputPath, flashPaletteFilename2)

	cfg.PalCfg.Path = flashPalettePath1
